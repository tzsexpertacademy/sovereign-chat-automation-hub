...
import { Bot, Plus, Play, Pause, Settings, Zap, MessageSquare, Clock } from "lucide-react";
...
const AutomationCenter = () => {
  const [automations, setAutomations] = useState([
    {
      ...
      enabled: true,
      executions: 145,
      lastRun: "Hoje às 18:05"
    },
    {
      id: "2",
      name: "IA - Atendimento Inicial",
      description: "IA responde perguntas básicas e qualifica leads automaticamente",
      type: "ai-chat",
      status: "active", 
      trigger: "keyword",
      enabled: true,
    ...
    },
    {
      ...
      description: "Envia mensagem de follow-up 3 dias após primeira conversa",
      type: "follow-up",
      status: "paused",
      trigger: "time-delay",
      enabled: false,
      executions: 23,
      lastRun: "Ontem às 14:30"
    },
    {
      id: "4",
      name: "Boas-vindas Novos Contatos",
      description: "Mensagem de boas-vindas para novos contatos que iniciam conversa",
      type: "welcome",
      status: "active",
      trigger: "new-contact",
      enabled: true,
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      case 'ai-chat': return <Bot className="w-5 h-5 text-purple-500" />;
      case 'auto-reply': return <MessageSquare className="w-5 h-5 text-blue-500" />;
      case 'follow-up': return <Clock className="w-5 h-5 text-orange-500" />;
      case 'welcome': return <Zap className="w-5 h-5 text-green-500" />;
  ...
  const getTriggerName = (trigger: string) => {
    ...
    return names[trigger as keyof typeof names] || trigger;
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500">de 4 total</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500">Execuções bem-sucedidas</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
                    ...
                    <div className="flex items-start space-x-4 flex-1">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <Badge variant="outline">{getTypeName(automation.type)}</Badge>
                          <Badge variant="secondary">{getTriggerName(automation.trigger)}</Badge>
                        </div>
