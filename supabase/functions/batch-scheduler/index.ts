...
Deno.serve(async (req) => {
  ...
  console.log('🤖 [BATCH-SCHEDULER] Iniciando verificação de batches...');

  try {
    // Loop infinito para verificar batches a cada 5 segundos
    while (true) {
    ...
    console.error('🤖 [BATCH-SCHEDULER] ❌ Erro geral:', error);
